          ...
          children: _jsxs("div", {
            ...
            children: [
              _jsx("h1", {
                ...
                children: "All part categories",
              }),
              _jsx("div", {
                className: "flex w-full items-center sm:justify-end",
                children: _jsx(AddPartCategoryModal, {}),
              }),
            ],
          }),
        }),
      }),
      _jsx(PartCategoriesTable, {}),
    ],
  });
};
const DeletePartCategoryModal = function () {
...
const AddPartCategoryModal = function () {
  const [isOpen, setOpen] = useState(false);
  return _jsxs(_Fragment, {
    children: [
      _jsxs(Button, {
...
const EditPartCategoryModal = (product) => {
  const [isOpen, setOpen] = useState(false);
  return _jsxs(_Fragment, {
    children: [
      _jsxs(Button, {
...
const PartCategoriesTable = function () {
  const { loading, error, data } = useQuery(GET_PART_CATEGORIES);
    ...
    children: [
      _jsxs(Table.Head, {
        ...
        children: [
          ...
          _jsx(Table.HeadCell, { children: "Position" }),
      ...
      _jsx(Table.Body, {
        ...
        children: data.partCategories.map((category) =>
          _jsxs(Table.Row, {
            ...
            children: [
              ...
              _jsx(Table.Cell, {
                ...
                children: category.position,
              }),
              _jsx(Table.Cell, {
                className:
                  "whitespace-nowrap p-4 text-base font-medium text-gray-900 dark:text-white",
                children: category.productType.name,
              }),
              _jsx(Table.Cell, {
                className:
                  "whitespace-nowrap p-4 text-base font-medium text-gray-900 dark:text-white",
                children: category.active ? "Yes" : "No",
              }),
              _jsx(Table.Cell, {
                  ...
                  children: [
                    _jsxs(Button, {
                      ...
                      children: [
                        ...
                        _jsx(Link, {
                          to: `/admin/part-categories/${category.id}`,
                          children: "View",
                        }),
                      ],
                    }),
                    _jsx(EditPartCategoryModal, {}),
                    _jsx(DeletePartCategoryModal, {}),
                  ],
                }),
              }),
            ],
